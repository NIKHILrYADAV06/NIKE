...
const MessagesScreen = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-[#0F1A24]" edges={["top"]}>
            {/* HEADER */}
                        ...
                        <View className="flex-1">
                            <View className="flex-row items-center justify-between mb-1">
                                <View className="flex-row items-center gap-1">
                                    <Text className="font-semibold text-[white]">{conversation.user.name}</Text>
            ...
            {/* Quick Actions */}
            <View className="px-4 py-2 border-t border-[#0F1A24] bg-[#0F1A24]">
            ...
            <Modal visible={isChatOpen} animationType="slide" presentationStyle="pageSheet">
                {selectedConversation && (
                    <SafeAreaView className="flex-1">
                        {/* Chat Header */}
                        <View className="flex-row items-center px-4 py-3 border-b border-[#0F1A24]">
                        ...
                        <ScrollView className="flex-1 px-4 py-4">
                            <View className="mb-4">
                                <Text className="text-center text-[#657786] text-sm mb-4">
                        ...
                        <View className="flex-row items-center px-4 py-3 border-t border-gray-100">
                            ...
                            <TouchableOpacity
                                onPress={sendMessage}
                                className={`size-12 rounded-full items-center justify-center ${newMessage.trim()
                                    }`}
